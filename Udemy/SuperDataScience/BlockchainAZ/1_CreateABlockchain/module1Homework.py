"""
    ...
    Creation Date:  2/2/2019, 3:01 PM
    Description:    Implement a new "is_valid_ request to check if the Blockchain is valid.
"""
...
# Create an is_valid check to validate the Blockchain
