...
def mine_block():
    ...
    blockchain.add_transaction(patient = node_address, doctor = 'Second Doctor', permission = 1)
...
def connect_node():
    ...
    response = {'message': 'All the nodes are now connected. The Medical Blockchain now contains the following nodes:',
