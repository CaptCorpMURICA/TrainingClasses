"""
    ...
    File:           fileIOChallenge.py
    Creation Date:  10/19/2018, 4:04 PM
    Description:    Write a program to append the times tables to our jabberwocky poem
...
# Create Times Tables File
# with open("times_tables.txt", 'w') as tables:
#     for i in range(1, 13):
#         for j in range(1, 13):
#             print("{1:>2} times {0} is {2}".format(i, j, i * j), file=tables)
#         print("-" * 20, file=tables)
