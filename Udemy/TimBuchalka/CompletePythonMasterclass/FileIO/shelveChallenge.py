"""
    ...
    File:           shelveChallenge.py
    Creation Date:  11/2/2018, 3:40 PM
    Description:    Modify the program from the Second Dictionary challenge of lecture 56
                    ...
                    Just to be clear, cave_game.py will contain the code from line 50, everything
